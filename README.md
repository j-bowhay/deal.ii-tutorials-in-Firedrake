# deal.ii Tutorial in Firedrake

This repository is an attempt to recreate the excellent [deal.ii tutorials](https://dealii.org/current/doxygen/deal.II/Tutorial.html)
in [Firedrake](https://www.firedrakeproject.org/).
